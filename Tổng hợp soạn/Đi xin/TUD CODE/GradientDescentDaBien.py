...
if __name__ == '__main__':
    ...
    # Linear regression
    # np.linalg.pinv(A) trong thư viện numpy của Python được sử dụng để tính giá trị giả nghịch đảo (pseudo-inverse) của một ma trận A
    # w = (X.T * X)^(-1) * X.T * y
